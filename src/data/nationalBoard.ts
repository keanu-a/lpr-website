...
export const nationalBoard: {
  ...
  },
  {
    ...
    bio: 'Leadership, Pride, and Respect. Thanks to the Fraternity, I found new meaning to these values and try to uphold them in everything I do. The Fraternity helped me grow into the leader and the man I am today. My goal is to have the same positive impact on the newer generation that the older heads on me. Leadership in our community, Pride in all that we do, Respect for all persons.',
    photo: christian,
  },
  {
    name: 'Raul Esteves',
